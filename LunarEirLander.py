...
# LunarEirLander is a slightyl modified version of the LunarLander game for use in COMP47590
#
#
...
#
# python examples/agents/keyboard_agent.py LunarEirLander-v0
#
...
class LunarEirLander(gym.Env):
    ...
    def reset(self):
        ...
        # MOD: Add a displacement so the ship starts anywhere across the top of the screen
        rand_displacement = np.random.randint(-1*VIEWPORT_W/SCALE/2, VIEWPORT_W/SCALE/2)
        initial_x = VIEWPORT_W/SCALE/2 + rand_displacement
        ...
        for i in [-1,+1]:
            leg = self.world.CreateDynamicBody(
                # MOD: Make sure legs stay with ship!
        ...
        for obj in self.particles + self.drawlist:
            for f in obj.fixtures:
                ...
                if type(f.shape) is circleShape:
                    #MOD: Don;t draw the little engine exhausts as the indicate directions too much for leearning
...
class LunarEirLanderContinuous(LunarEirLander):
    continuous = True
